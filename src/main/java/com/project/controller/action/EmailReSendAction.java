...
public class EmailReSendAction implements Action{
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String hash = dao.searchEmailHash(email);
		
		String subject = "인증 이메일";
		String content = "링크에 접속해 이메일 인증을 진행해 주세요.. "+ "<a href ='" + host + "UserServlet?command=emailCheckAction&code=" + hash + "'>이메일 인증하기</a>";
