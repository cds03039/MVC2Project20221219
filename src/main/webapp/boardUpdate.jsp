...
<form name="frm" method="post" enctype="multipart/form-data" action="BoardServlet?command=board_update&category=${board.category }">
	...
	<div class="bigWrapper">
		...
		<div class="writingMain">
			<div class="writingHeader">
				...
				<div class="title">
					제목 : <input type="text" placeholder="제목 입력" class="titleText" name="board_title" value="${board.board_title }">
				</div>
				<div class="profile">
					<span>닉네임 : ${board.nickname }</span>
				</div>
			</div>
			<br>
			<div class="content">
				<div class="wrap">
					...
					<div id="editor" contenteditable="true">${board.board_content }<img src="upload/${board.pictureUrl}" alt="" class="imgBox"></div>
			...
			<div class="Box">
				...
				<a id="refreshBtn" onclick="imgRefresh()" class="refresh">새로고침</a> <input
					type="submit" value="수정완료" class="enter" onclick="passOnContent()">
			</div>
			<br>
			<br>
			<br>
